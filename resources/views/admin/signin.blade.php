                        ...
                        <form role="form" method="post">
                            <fieldset>
                                ...
                                <div class="form-floating mb-3">
                                    <input type="email" name="email" class="form-control" id="floatingInput" placeholder="E-mail" autofocus="" value="{{old('email')}}">
                                ...
                                <p class="text-center mb-0">Bạn không có tài khoản ? <a href="{{asset('register')}}">Đăng kí</a>
                                </p>
                            </fieldset>
                            {{csrf_field()}}
                        </form>
