                    ...
                    <table class="table text-start align-middle table-hover mb-0">
                        <thead>
                            <tr class="text-white" style="text-align: left;">
                                <th scope="col">SỬA MÀU SẢN PHẨM</th>
                            </tr>
                        </thead>
                        <tbody>
                            @include('errors.note')
                            <form action="" method="post">
                                ...
                                <tr class="text-white">
                                    <td><input style="background-color: white;" type="text" name="name" class="form-control" placeholder="Tên danh mục..." value="{{$color->color_name}}"></td>
                                </tr>
                                <tr class="text-white" style="text-align: left;">
                                    <td>Hiển thị:</td>
                                </tr>
                                <tr class="text-white">
                                    <td style=" text-align: left !important;">
                                        <select required name="status" id="">
                                            <option value="0" @if($color->color_status == 0) selected @endif>Ẩn</option>
                                            <option value="1" @if($color->color_status == 1) selected @endif>Hiển thị</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr class="text-white">
                                ...
                                <tr class="text-white">
                                    <td>
                                        <a href="{{asset('admin/mauson')}}" class="btn btn-primary py-2 w-100 mb-4">HỦY BỎ</a>
                                    </td>
                                </tr>
                                {{csrf_field()}}
                            </form>
